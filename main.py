...
from dataset import generate_dateset
...
def dqn_cart_pole():
    ...
    config.replay_fn = lambda: Replay(memory_size=1000, batch_size=10)
...
if __name__ == '__main__':
    ...
    # generate_dateset('BreakoutNoFrameskip-v4')
    acvp.train('BreakoutNoFrameskip-v4', twoway=True)
